...
<head>
	...
	<link href="{{ asset('css/cs-skin-border.css') }}" rel="stylesheet">
					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li>
									<a href="{{ route('destinations.index') }}" class="fh5co-sub-ddown">{{
								...
								@else
									...
									<li><a href="{{ route('register') }}">{{ trans('messages.signup') }}</a></li>
									@endif
									@endauth
											...
											<div role="tabpanel" class="tab-pane active" id="flights">
												<div class="row">
													...
													<div class="col-sm-12 mt">
														<section>
															<label for="category">{{ trans('messages.category')
																}}:</label>
													...
													<div class="col-xxs-12 col-xs-6 mt alternate">
														<div class="input-field">
															<label for="date-start">{{ trans('messages.when')
																}}:</label>
