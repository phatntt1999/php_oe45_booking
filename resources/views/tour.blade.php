...
<link rel="stylesheet" href="{{  mix('/assets/system/css/tour.css') }}">
@livewireStyles
@section('header')
      ...
      <div class="row">
         ...
         <div class="col-lg-9 posts-list">
               ...
               <div class="p-heading">
                  ...
                  <div class="main-review">
                     ...
                     <span class="r-based">{{ trans('messages.base_on') }}<a href="javascript:void(0)"
                           id="scroll-to-reviews"> {{ $tour->ratings->count() }} {{ trans('messages.reviews')
                           }}</a></span>
                  </div>
               </div>
                     ...
                     <div class="col-xxs-12 col-xs-6 mt">
                        <div class="col-xxs-12 col-xs-6 mt">
                           <div class="input-field">
                              ...
                              <h1 class="h1-text">{{ trans('messages.instant') }}</h1>
                           </div>
                        </div>
                        <div class="col-xxs-12 col-xs-6 mt">
                           <div class="input-field">
                              <label for="destination">{{ trans('messages.duration') }}:</label>
                              <h1 class="h1-text">{{ $tour->duration}} {{ trans('messages.days') }}</h1>
                           </div>
                        </div>
                        <div class="col-xxs-12 col-xs-6 mt">
                           <div class="input-field">
                              <label for="destination">{{ trans('messages.max_group') }}:</label>
                              <h1 class="h1-text">{{ $tour->num_group}} {{ trans('messages.people') }}</h1>
                           </div>
                        </div>
                        <div class="col-xxs-12 col-xs-6 mt">
                           <div class="input-field">
                              <label for="destination">{{ trans('messages.age') }}:</label>
                              <h1 class="h1-text">3+ {{ trans('messages.yearsold') }}</h1>
                           </div>
                        </div>
                     </div>
                     <div class="col-xxs-12 col-xs-6 mt">
            ...
            <div class="comments-area">
               @livewire('product-ratings', ['tour' => $tour], key($tour->id))
