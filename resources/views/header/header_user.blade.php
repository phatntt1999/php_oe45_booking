                                        ...
                                        <ul class="dropdown-menu">
                                                ...
                                                @if (Auth::user()->role == 'admin')
                                                    ...
                                                    <li class="notification active">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <br>
                                                            <small class="notification-desc">{{ $notification->data['content'] }} </small>
                                            ...
                                            <li class="notification active">
                                                <div class="media">
                                                  ...
                                                  <div class="media-body">
                                                    <strong class="notification-title">There are no notification</strong>
                                                    <br>
                                                  </div>
                                                </div>
                                            </li>
...
<script src="{{ asset('/assets/js/processBookingNotification.js') }}"></script>
